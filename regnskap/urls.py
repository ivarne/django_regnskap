...
urlpatterns = patterns('django_regnskap.regnskap.views',
    ...
    url(r'^registrer/(\w+)/kontoutskrift$',     'kontoutskrift_import.kontoutskrift_import'),
    url(r'^registrer/(\w+)/drafts$',            'kontoutskrift_import.show_drafts'),
    url(r'^registrer/(\w+)/drafts/\d+$',        'kontoutskrift_import.show_drafts'),
    ...
    url(r'^show/konto_graph/(\d{4})-(\d+).png', 'graphs.konto_graph'),
    url(r'^show/konto_graph_bar/(\d{4})-(\d+).png', 'graphs.konto_graph_bar'),
